...
export default {
    ...
    methods: {
        ...
        async sendAuthCode() {
            ...
            try {
                const response = await axios.post(`${process.env.VUE_APP_API_BASE_URL}/sms/send-auth`, { phoneNumber: this.phoneNumber });
        ...
        async verifyAuthCode() {
            try {
                const response = await axios.post(`${process.env.VUE_APP_API_BASE_URL}/sms/verify-auth`, {
                    phoneNumber: this.phoneNumber,
                    authCode: this.authCode
                });
